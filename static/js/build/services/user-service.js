...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.profile = function (name, second_name, email, password, login, phone) {
        return HTTP.put('/user/profile', { name: name, second_name: second_name, email: email, login: login, password: password, phone: phone })
            .then(function (data) {
            console.log(data);
        }.bind(this));
    };
